...
router.post('/superAdmin/crear/producto', authMiddleware, roleMiddleware('SuperAdmin'), validateMiddleware(productSchema), createProduct);
...
router.post('/admin/crear/producto', authMiddleware, roleMiddleware('Admin'), validateMiddleware(productSchema), createProduct);
